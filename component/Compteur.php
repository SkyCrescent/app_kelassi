    ...
    <body>
            <div class="hidden md:block overflow-y-auto scrollbar-hidden relative h-[100%]  w-[100%]   ">
                 <div class="relative top-2 h-auto content-container overflow-hidden ">
                    <div class="w-full shadow-lg h-auto ">
                        <div class="grid grid-cols-12 text-xs p-2 md:p-1  bg-blue-500 md:uppercase">
<!--                            <h2 class="text-white font-[Gotham] border border-white w-6">Heure</h2>-->
<!--                          -->
                            <h2 class="text-white font-[Gotham] border border-white col-span-2 ">Lundi</h2>
                            <h2 class="text-white font-[Gotham] border border-white col-span-2 ">Mardi</h2>
                            <h2 class="text-white font-[Gotham] border border-white col-span-2">Mercredi</h2>
                            <h2 class="text-white font-[Gotham] border border-white col-span-2">Jeudi</h2>
                            <h2 class="text-white font-[Gotham] border border-white col-span-2">Vendredi</h2>
                            <h2 class="text-white font-[Gotham] border border-white col-span-2">Samedi</h2>
                            <h2 class="text-white font-[Gotham] border border-white col-span-2">Dimanche</h2>
                        </div>
                     </div>
                </div>
            </div>
